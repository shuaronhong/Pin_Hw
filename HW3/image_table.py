        ...
        try:
            ...
            for img_index, item in enumerate(page_images):
                try:
                    ...
                    image_save_path = f'{image_dir}/{pdf_name}_img_{page_num + 1}_{img_index + 1}_{timestamp}.png'
                    #xref is in memory, so will not be able to know prior runs
...
if __name__ == "__main__":
    ...
    # results = extract_tables_from_pdf(pdf_path_tables)
